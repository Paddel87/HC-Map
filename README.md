...
[![Phase](https://img.shields.io/badge/phase-M5b.3--erledigt-blue)](./docs/fahrplan.md#phasen-übersicht)
...
| Phase | Stand |
|---|---|
| Phase 1 — MVP / Go-Live Pfad A | M0–M4 erledigt, M5a komplett, M5b.1–M5b.3 erledigt (Sync-Datenmodell + Backend-Sync-Endpoints + Frontend-RxDB-Schicht: lokal-zuerst-Schreibpfad, reaktive UI-Subscriptions, Sync-Status-Pill in Sidebar/Mobile-Header, Backend-Sync-Coverage 91 %, Frontend-Suite 60/60); M5b.4 (E2E-Offline-Test) als nächstes |

...
- **Stand vom:** 2026-05-01 (laufende Session — achter Sub-Step **M10.8 (`ops/runbook.md` + README-Restruktur, Operator-Quickstart)** [ERLEDIGT]. Test-Stand unverändert: Backend pytest **246/246**, Frontend vitest **278/278**, `format:check` clean, `actionlint` clean (M10.8 berührt ausschließlich Doku, keine Test-relevanten Files). **Commit-Stand:** Branch `claude/naughty-roentgen-917f18` (Worktree).)
...
- **Sub-Folgearbeit aus Blocker #002:** Sub-Schritt **M10.7.1 (Action-Versions-Audit + Node-24-Bumps)** vor M10.9 anlegen oder in M10.9 mitnehmen — Stichtag 2026-06-02 (Runner zwingt Node 24).
- **Übersicht über die noch offenen M10-Sub-Steps:** M10.9 (RC-Smoke + Tag `v0.1.0-rc.1` + GitHub-Pre-Release); ggf. M10.7.1 als kurzer Audit-Sub-Step davor.

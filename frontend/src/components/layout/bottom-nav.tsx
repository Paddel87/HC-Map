...
export function BottomNav({ user }: { user: AuthUser }) {
  ...
  return (
    <nav className="sticky bottom-0 z-40 grid grid-cols-4 border-t border-slate-200 bg-white pb-[env(safe-area-inset-bottom)] md:hidden dark:border-slate-800 dark:bg-slate-950">
      {items.map((item) => {
